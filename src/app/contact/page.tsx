        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              <div className="liquid-glass p-6 sm:p-8 rounded-2xl border border-primary/10 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3 text-sm">
                    ...
                    <div>
                      <h4 className="text-foreground font-semibold">Head Office</h4>
                  ...
                  <div className="flex items-start space-x-3 text-sm">
                    ...
                    <div>
                      <h4 className="text-foreground font-semibold">Phone Support</h4>
                  ...
                  <div className="flex items-start space-x-3 text-sm">
                    ...
                    <div>
                      <h4 className="text-foreground font-semibold">Email Inquiries</h4>
                      <a
                ...
                <div className="pt-4 border-t border-primary/10 space-y-3">
                  <h4 className="text-foreground font-bold text-xs uppercase tracking-wider">Social Profiles</h4>
                  <div className="flex items-center space-x-4">
                    <a
                      href="https://www.facebook.com/people/Futurex-DigitalMarketing/61582411168285/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-9 h-9 rounded-lg border border-primary/10 bg-primary/5 hover:bg-primary/20 hover:border-primary/50 flex items-center justify-center transition-all duration-300"
                      aria-label="Facebook"
                    >
                      <svg className="w-4 h-4 text-foreground/80 fill-current" viewBox="0 0 24 24">
                    ...
                    >
                      <svg className="w-4 h-4 fill-none stroke-current stroke-2 text-foreground/80" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="bg-secondary/35 border border-primary/10 p-6 rounded-2xl space-y-3">
                <h3 className="font-bold text-foreground text-sm">International Client Desk</h3>
