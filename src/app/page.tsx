...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="relative min-h-screen pt-24 pb-12 overflow-hidden bg-background">
        ...
        <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20 md:py-32">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Link href="/contact" className="glow-btn-primary w-full sm:w-auto px-8 py-4 rounded-xl text-base font-extrabold text-white text-center shadow-lg">
                Book Free Audit
              </Link>
              <Link href="/services" className="glow-btn-secondary w-full sm:w-auto px-8 py-4 rounded-xl text-base font-extrabold text-white text-center flex items-center justify-center space-x-2">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat, i) => (
              ...
              >
                <div className="text-3xl sm:text-4xl font-extrabold bg-gradient-to-r from-white to-primary-hover bg-clip-text text-transparent">
                  {stat.value}
                </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="pt-2">
                <Link href="/about" className="glow-btn-secondary px-6 py-3 rounded-xl text-sm font-bold text-white flex items-center justify-center space-x-2 w-fit">
            ...
            <div className="liquid-glass p-8 rounded-3xl relative overflow-hidden flex flex-col justify-center space-y-6 border border-primary/20">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h4 className="text-white font-bold">Premium Quality Standards</h4>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h4 className="text-white font-bold">Global Agency Expertise</h4>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
          <div className="text-center space-y-3 mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white">High-Impact Growth Solutions</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mainServices.map((svc) => (
              <Link
                ...
                className="liquid-glass liquid-glass-hover p-6 rounded-2xl space-y-4 flex flex-col justify-between group"
              >
          ...
          <div className="flex justify-center mt-12">
            <Link href="/services" className="glow-btn-secondary px-8 py-3.5 rounded-xl text-sm font-bold text-white">
        ...
        {/* CORE VALUES */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-secondary/30 rounded-3xl border border-white/5 my-12">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-white">Why Modern Brands Choose FutureX</h2>
              <p className="text-foreground/75 leading-relaxed">
            ...
            <div className="relative flex justify-center items-center">
              ...
              <div className="liquid-glass p-8 rounded-2xl max-w-md w-full relative z-10 border border-primary/20 space-y-6">
                <h4 className="text-white font-bold text-center border-b border-white/5 pb-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  {["United States", "United Kingdom", "Australia", "UAE (Dubai)", "London Focus", "Udaipur Local"].map((loc, idx) => (
                    <div key={idx} className="bg-white/5 border border-white/10 rounded-lg p-2.5 text-xs text-foreground/80 font-semibold">
                      {loc}
                    </div>
                  ))}
                </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
          ...
          <div className="text-center space-y-3 mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white">Trusted Globally</h2>
          </div>
          ...
          <div className="flex justify-center mt-10">
            <Link href="/testimonials" className="glow-btn-secondary px-6 py-3 rounded-xl text-sm font-bold text-white">
              Read More Client Stories
            </Link>
          </div>
        </section>

        {/* HIGH CONVERTING MAIN CTA SECTION */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="liquid-glass p-8 md:p-12 rounded-3xl text-center space-y-6 border border-primary/30 shadow-[0_0_30px_rgba(96,45,238,0.15)] relative overflow-hidden">
            ...
            <p className="text-foreground/80 max-w-xl mx-auto text-sm md:text-base leading-relaxed">
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                >
                  <p className="px-6 pb-5 pt-1 text-foreground/75 text-xs sm:text-sm leading-relaxed border-t border-white/5">
                    {faq.a}
                  </p>
                </div>
              </div>
